(function() {
   ...
   * assignment pre-completed, be sure to read and understand it fully beforer
  ...
  _.last = function(array, n) {
   return n===0 ? [] : array.length < n ? array : 
    n===undefined ? array[array.length-1] : array.slice(n-1,array[array.length-1]) 
  ...
  _.reject = function(collection, test) {
    ...
    return _.filter(collection,function(element,i){
      return !(test(element));
    })
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection,function(total,element,i){
     return  iterator===undefined  ? total && element : total && !!iterator(element)
    },true)
  };
